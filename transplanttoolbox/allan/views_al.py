...
class AlleleListApiView(generics.GenericAPIView):
    """Returns antigens for a list of IPD-IMGT/HLA alleles. Enter IPD-IMGT/HLA alleles in the list either fully resolved or upto second field with expression characters. The output yielded include UNOS antigen equivalencies and presence of Bw4 and Bw6 epitopes is indicated."""
    ...
    def post(self, request):
        """Returns UNOS antigen for a list of IPD-IMGT/HLA alleles. Enter IPD-IMGT/HLA alleles in the list either fully resolved or upto second field with expression characters. The output yielded include UNOS antigen equivalencies and presence of Bw4 and Bw6 epitopes is indicated."""
