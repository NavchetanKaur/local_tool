...
def home_1(request):
    return render(request, 'allan/home_1.html')

def license(request):
    return render(request, 'allan/license.html')    

def allele(request):
    return render(request, 'allan/allele.html')

def allele_list(request):
    return render(request, 'allan/allele_list.html')    

def gl_string(request):
    return render(request, 'allan/gl_string.html')  


def allele_codes(request):
    return render(request, 'allan/allele_codes.html')  

def reverse (request):
    return render(request, 'allan/reverse.html')
...
def convert(request):
    ...
    if uinput in valid_allele_check:
        ...
        return render(request, 'allan/convert.html', {'uinput': uinput, 'conversion': ag_eq, 'bw4_6': bw4_6})   
    else:
...
def convert_2(request):
    ...
    return render(request, 'allan/convert_2.html', {'zipped_list': zip(allele_list, ag_list, bw46_list), 'ags_returned': ageps_mapped})
...
def convert_3(request):
    ...
    return render(request, 'allan/convert_3.html', {'pop_entry' : pop_selected, 
...
def convert_4(request):
    ...
    #print(type(uinput_1))
    uinput_1 = uinput_1.strip()
    #uinput_1 = uinput_1.encode("ascii", "replace")
    ...
    pop_selected = pop_acro_dict[uinput_2]
    return render(request, 'allan/convert_4.html', {'pop_entry' : pop_selected, 
...
def convert_5(request):
    ...
    return render(request, 'allan/convert_5.html', {'uinput': uinput, 'conversion': alleles_ouput, 'alleles_returned': alleles_mapped, "ags_e": ags_eq, 
