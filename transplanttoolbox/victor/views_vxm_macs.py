...
class MultipleAlleleCodesApiView(generics.GenericAPIView):
    ...
    def post(self, request, format=None):
        """Computes VXM when donor HLA typing is available as NMDP multiple allele codes. Results also give the probability of VXM for each conflicting unacceptable antigen"""
        """parameters: 
        allele:string
        """
